...
| Ciberseguranca (transversal) | [features/security](features/security/readme.md) | RBAC single-tenant, rate limits, revogacao de sessao; rotas publicas minimas. |
...
| Seed de dev e validacao | [features/dev-seed-and-validation](features/dev-seed-and-validation/readme.md) | Admin `admin@lignum.local`; seed **minimo** idempotente; bulk opcional manual. |
...
| Matriz de autorizacao | [security/authorization-matrix.md](security/authorization-matrix.md) | Checklist canonico de role e scope check por rota (single-tenant). |
| Auditoria, consultas externas | [audit/readme.md](audit/readme.md) | Registro de consultas SENATRAN; acesso admin; custo. |

## Testes E2E e seguranca

Os cenarios de fumo e integracao criticos vivem em `e2e/` e sao executados com **Chromium**. Setup admin: `admin@lignum.local` (seed minimo). Specs legacy de storefront/plataforma removidos no cycle 0623.
